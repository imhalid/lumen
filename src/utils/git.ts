...
// Use the public isomorphic-git CORS proxy in development,
// and fall back to the self-hosted proxy in production (optional).
const CORS_PROXY =
  import.meta.env.DEV ? "https://cors.isomorphic-git.org" : undefined
